...
Provide your response in a structured JSON format conforming to the output schema. Ensure the explanation is comprehensive and the tips are practical and distinct.

Example Calculation for desired margin:
If cost is 100 and desired margin is 20%, the selling price would be 100 / (1 - 0.20) = 125.

Consider the user's currency symbol in your response.`,
});
